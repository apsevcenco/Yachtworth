...
const styles = StyleSheet.create({
  ...
  panelTitle: { fontFamily: "Gilroy-Bold", fontSize: 18, lineHeight: 23, marginBottom: 2 , fontWeight: "700"},
  ...
  rowTitle: { fontFamily: "Gilroy-Bold", fontSize: 15, lineHeight: 20 , fontWeight: "700"},
