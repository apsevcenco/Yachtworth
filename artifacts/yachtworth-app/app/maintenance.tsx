...
const styles = StyleSheet.create({
  ...
  title: { color: IVORY, fontFamily: "Gilroy-ExtraBold", fontSize: 34, marginTop: 6 },
  ...
  sectionTitle: { color: IVORY, fontFamily: "Gilroy-Bold", fontSize: 18, marginBottom: 12 , fontWeight: "700"},
  ...
  rowText: { flex: 1 },
  rowTitle: { color: IVORY, fontFamily: "Gilroy-Bold", fontSize: 15 , fontWeight: "700"},
