...
const styles = StyleSheet.create({
  ...
  heroTitle: { color: IVORY, fontFamily: "Gilroy-ExtraBold", fontSize: Platform.OS === "web" ? 48 : 34, lineHeight: Platform.OS === "web" ? 56 : 40, marginTop: 10 },
  ...
  emptyTitle: { color: IVORY, fontFamily: "Gilroy-Bold", fontSize: 18 , fontWeight: "700"},
  ...
  cardTitle: { color: IVORY, fontFamily: "Gilroy-Bold", fontSize: 18, lineHeight: 24 , fontWeight: "700"},
