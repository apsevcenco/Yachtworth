...
const styles = StyleSheet.create({
  ...
  timelineText: { flex: 1 },
  timelineTitle: { fontFamily: "Gilroy-Bold", fontSize: 14, lineHeight: 19 , fontWeight: "700"},
  ...
  qrHint: { position: "absolute", right: 10, bottom: 10, width: 260, minHeight: 150, borderWidth: 1, borderRadius: 8, padding: 10 },
  qrHintTitle: { fontFamily: "Gilroy-Bold", fontSize: 12 , fontWeight: "700"},
