    ...
    try {
      await exportSurveyDocument({
        report: {
          ...
          loa_meters: report.loa_meters,
          lwl_meters: report.lwl_meters,
          beam_meters: report.beam_meters,
          draft_meters: report.draft_meters,
          displacement_text: report.displacement_text,
          hull_material: report.hull_material,
          deck_material: report.deck_material,
          keel_type: report.keel_type,
          engines_text: report.engines_text,
          transmissions_text: report.transmissions_text,
          fuel_capacity_l: report.fuel_capacity_l,
          fresh_water_l: report.fresh_water_l,
          black_water_l: report.black_water_l,
          grey_water_l: report.grey_water_l,
          specification_source: report.specification_source,
          flag: report.flag,
          hin: report.hin,
          lying: report.lying,
          ...
          survey_scope: report.survey_scope,
          standards_referenced: report.standards_referenced,
        ...
        items: items.map((it) => ({
          ...
          estimated_cost_eur: it.estimated_cost_eur,
