...
export default function ListingEntryScreen() {
  ...
  return (
    <View style={[styles.root, { paddingTop: (isWeb ? 67 : insets.top) + 56 }]}>
      ...
      >
        ...
        <Text style={styles.kicker}>AI TOOL</Text>
        <Text style={styles.title}>Listing Generator</Text>
        <Text style={styles.subtitle}>
          AI-powered professional yacht listing copy for sale or charter.
        </Text>
        ...
        {loading ? (
          ...
          <View style={styles.emptyBlock}>
            ...
            <Text style={styles.emptyText}>
              Add a yacht to My Yacht to auto-fill listing details, or enter
        ...
        >
          ...
          <Text style={styles.savedLinkText}>My saved listings</Text>
