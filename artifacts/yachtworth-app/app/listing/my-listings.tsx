...
function labelListingType(t: string): string {
  return t === "sale"
    ? "For Sale"
    : t === "charter"
      ? "For Charter"
...
export default function MyListingsScreen() {
  ...
  const detailQ = useGetListing(openId ?? "", {
    query: {
      queryKey: openId ? getGetListingQueryKey(openId) : ["listing-detail-disabled"],
      enabled: !!openId,
    },
  });
  ...
  // When detail loads, navigate to result screen with saved snapshots.
  React.useEffect(() => {
    if (!openId) return;
    ...
    router.push({
      ...
      params: {
        ...
        yacht_name: d.yacht_name,
        listing_type: d.listing_type,
        style: d.style,
        language: d.language,
        word_length: d.word_length,
        ai_used: d.ai_used ? "1" : "0",
        yacht_id: d.yacht_id ?? "",
        ...
        {listQ.isLoading ? (
          ...
          <View style={styles.emptyBlock}>
            ...
            <Text style={styles.emptyText}>
              Generate a yacht listing from the Tools tab to save it here.
            </Text>
            <Pressable
            ...
            >
              <Text style={styles.emptyBtnText}>Open Listing Generator</Text>
            </Pressable>
          </View>
        ) : (
                ...
                >
                  <View style={{ flex: 1 }}>
                    ...
                    <View style={styles.itemChips}>
                      <Chip text={labelListingType(it.listing_type)} />
