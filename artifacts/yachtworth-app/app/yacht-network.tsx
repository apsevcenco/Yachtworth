...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: IVORY, fontFamily: "Gilroy-Bold", fontSize: 18, marginBottom: 10 , fontWeight: "700"},
  ...
  listingTitle: { color: IVORY, fontFamily: "Gilroy-Bold", fontSize: 18, lineHeight: 24 , fontWeight: "700"},
  ...
  contactTitle: { color: IVORY, fontFamily: "Gilroy-Bold", fontSize: 13 , fontWeight: "700"},
