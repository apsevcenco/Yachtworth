...
const styles = StyleSheet.create({
  ...
  title: { color: IVORY, fontFamily: "Inter_700Bold", fontSize: 30, marginTop: 6 },
  ...
  cardTitle: { color: IVORY, fontFamily: "Inter_700Bold", fontSize: 22, lineHeight: 28 },
  ...
  blockTitle: { color: GOLD, fontFamily: "Inter_600SemiBold", fontSize: 11, letterSpacing: 1.6, textTransform: "uppercase", marginBottom: 6 },
