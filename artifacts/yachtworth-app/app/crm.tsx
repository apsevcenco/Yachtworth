...
const styles = StyleSheet.create({
  ...
  searchBox: { flex: 1, minWidth: 260, minHeight: 52, borderRadius: 14, borderWidth: 1, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", gap: 10 },
  ...
  contactName: { fontFamily: "Inter_800ExtraBold", fontSize: 15 },
  ...
  detailName: { fontFamily: "Gilroy-ExtraBold", fontSize: 27 },
  ...
  smallButton: { minHeight: 38, borderRadius: 12, borderWidth: 1, flexDirection: "row", alignItems: "center", gap: 7, paddingHorizontal: 12 },
  smallButtonText: { fontFamily: "Inter_800ExtraBold", fontSize: 12 },
