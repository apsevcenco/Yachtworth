...
const styles = StyleSheet.create({
  ...
  contactName: { fontFamily: "Gilroy-Bold", fontSize: 15, lineHeight: 20 , fontWeight: "700"},
  ...
  sectionTitle: { fontFamily: "Gilroy-Bold", fontSize: 14, marginTop: 4, textTransform: "uppercase", letterSpacing: 1.1 , fontWeight: "700"},
  rowCard: { borderRadius: 12, borderWidth: 1, padding: 12, gap: 4 },
  openableRow: { flexDirection: "row", alignItems: "center", gap: 10 },
  rowTitle: { fontFamily: "Gilroy-Bold", fontSize: 14, lineHeight: 19 , fontWeight: "700"},
