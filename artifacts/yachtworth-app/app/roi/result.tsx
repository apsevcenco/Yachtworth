...
function assumptionLines(data: RoiCalculation): string[] {
  ...
  const fallback = [
    "Cumulative cash flow models charter ramp-up: year 2 +15% charter income, year 3 +23% total charter income, then stable charter activity; operating expenses inflate at 3.0%/yr.",
