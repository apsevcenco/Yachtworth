...
export interface YachtRow {
  ...
  social_security_mode?: string | null;
  social_security_pct?: number | string | null;
  social_security_fixed_monthly_eur?: number | string | null;
  social_security_fixed_months?: number | string | null;
  monthly_crew_eur?: number | string | null;
  monthly_mooring_eur?: number | string | null;
  monthly_mooring_months?: number | string | null;
  monthly_fuel_eur?: number | string | null;
  monthly_fuel_months?: number | string | null;
  monthly_provisioning_eur?: number | string | null;
  monthly_provisioning_months?: number | string | null;
  monthly_communications_eur?: number | string | null;
  monthly_communications_months?: number | string | null;
  monthly_maintenance_eur?: number | string | null;
  monthly_maintenance_months?: number | string | null;
  monthly_management_fee_eur?: number | string | null;
  monthly_management_fee_months?: number | string | null;
  monthly_misc_eur?: number | string | null;
  monthly_misc_months?: number | string | null;
