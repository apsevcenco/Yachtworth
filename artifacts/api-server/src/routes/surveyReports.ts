...
router.post(
  ...
  async (req, res): Promise<void> => {
    ...
    const row = {
      ...
      loa_meters: body.loa_meters ?? null,
      lwl_meters: body.lwl_meters ?? null,
      beam_meters: body.beam_meters ?? null,
      draft_meters: body.draft_meters ?? null,
      displacement_text: body.displacement_text ?? null,
      hull_material: body.hull_material ?? null,
      deck_material: body.deck_material ?? null,
      keel_type: body.keel_type ?? null,
      engines_text: body.engines_text ?? null,
      transmissions_text: body.transmissions_text ?? null,
      fuel_capacity_l: body.fuel_capacity_l ?? null,
      fresh_water_l: body.fresh_water_l ?? null,
      black_water_l: body.black_water_l ?? null,
      grey_water_l: body.grey_water_l ?? null,
      specification_source: body.specification_source ?? null,
      flag: body.flag ?? null,
      hin: body.hin ?? null,
