...
- **Stage 4 (next):** Seed `market_rates` + `expense_rates` таблиц реальными данными (заменит heuristic fallbacks на data-driven), либо переход к Day 6 (RevenueCat paywall) — на усмотрение владельца.
